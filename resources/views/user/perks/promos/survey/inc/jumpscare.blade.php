<div class="modal fade xp-modal" id="jumpscareModal" tabindex="-1" aria-labelledby="jumpscareModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="xp-title-bar px-3 py-2 d-flex align-items-center position-relative">
                ...
                <span>Extranet Explorer &copy; 3002 | Boo</span>
            ...
            <div class="modal-body p-0">
                <img src="{{ asset('images/ads/jumpscare.jpg') }}" class="img-fluid w-100" alt="boo"
