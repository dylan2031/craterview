...
@section('content')
        ...
        <div class="container" >
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <h5>Family pool</h5>
                    <p>A safe, shallow space designed for families with small children. Supervised by repurposed factory bots at times.</p>
                </div>
            </div>
        </div> 
    </section>
    ...
    <section>
        ...
        <div class="container">
            ...
            {{-- Show treatments in table on desktop --}}
            <table class="table table-striped table-bordered mt-2 d-none d-md-table">
            ...
            {{-- Simplify treatment display on mobile --}}
            <div class="d-block d-md-none">
                @foreach($treatments as $treatment)
                    <div class="mb-3 p-3 border rounded bg-light">
                        <strong>{{ $treatment['name'] }}</strong><br>
                        <small>{{ $treatment['desc'] }}</small><br>
                        <span class=" small text-muted">Duration&colon; {{ $treatment['duration'] }}</span>
                    </div>
                @endforeach
            </div>
            <small class="fst-italic">Appointments by walk-in only. Actual durations may vary due to individual responses to synthetic compounds and recovery times.</small>
            <br>
        </div>
    </section>
@endsection