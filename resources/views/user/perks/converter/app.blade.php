        ...
        <div class="card bg-dark text-light border-primary shadow-lg">
            <div class="card-body p-5">
                    <p class="display-5 fw-bold" style="font-family : Orbitron">
                        <span style="color:#7fff00;">&pound;{{ number_format($amount, 2) }}</span>
                        <br>
                    ...
                    <div class="fw-bold mb-4">
                        1 EARTH POUND &lpar;&pound;&rpar; = 1.42 OMNIDOLLAR &lpar;&Omega;&rpar;
                    </div>
                <form method="POST" action="{{ url()->current() }}">
                    ...
                    <div class="mb-3 input-group">
                        ...
                        <input
                            ...
                            name="amount"
                            placeholder="Enter amount in &pound;"
                            required
                        >
                    </div>
                    <div class="d-grid">
                ...
                @endif
               <p class="fw-bold mt-4"><a href="/dashboard/galactic-currency-converter">Convert from Universal Galactic Credits instead</a></p>
