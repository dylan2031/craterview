    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="xp-title-bar px-3 py-2 d-flex align-items-center position-relative">
                ...
                <span>Extranet Explorer &copy; 3002 | Sign out?</span>
            ...
            <div class="modal-body p-0">
                <div class="container-flex bg-light text-dark text-center">
                    ...
                    <p style="font-family: sans-serif;">Are you sure you want to sign out?</p>
                    <button type="button" class="btn xp-btn-secondary" onclick="document.getElementById('logout-form').submit();">Sign Out</button>
