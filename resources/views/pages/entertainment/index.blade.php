...
@section('content')
    ...
    <section class="position-relative text-center text-light text-shadow-black">
        ...
        <div class="position-absolute top-50 start-50 translate-middle w-100 px-3">
            ...
            <h5>The ultimate 3-star destination for things to do.</h5>
            <h5 class="mt-4">The excitement, adventure, and gambling never stops at Craterview's out-of-this-world entertainment hub.</h5>
        </div>
    </section>
    {{-- Show entertainment --}}
    <section id="results">
            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-12 col-md-2">
                    <div class="d-flex flex-column flex-md-row justify-content-center gap-2 w-100">
                        <!-- submit -->
                        <button type="submit" class="btn xp-btn-secondary w-100 text-nowrap">
                            <i class="bi bi-search"></i> Search
                        </button>
                        <!-- options -->
                        <button type="button" class="btn xp-btn-secondary w-100 text-nowrap" aria-label="Toggle filter options" data-bs-toggle="collapse" data-bs-target="#filterOptions">
            ...
            <div id="filterOptions" class="collapse mt-3">
                <div class="row m-4">
                    <div class="col-md-4 form-check">
                        ...
                        <p class="mt-5 fw-bold">Age Suitability</p>
                    ...
                    <div class="col-md-4 form-check">
                        <p class="mt-5 mt-md-0 fw-bold">Category</p>
                    ...
                    <div class="col-md-4 form-check">
                        <p class="mt-5 mt-md-0 fw-bold">Locations</p>
