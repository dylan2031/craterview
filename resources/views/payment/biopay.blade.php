...
<audio id="bioPayAudio" style="visibility: hidden;">
  <source src="{{ asset('audio/biopay.wav') }}" type="audio/wav">
</audio>

<div class="modal fade xp-modal" id="bioModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
      ...
      <div class="modal-body text-center bg-light">
        ...
        <div class="video-wrapper">
          ...
          <div class="retro-scan-overlay">
            <img src="{{ asset('images/payment/face.png') }}" id="faceImg" class="face-img d-none">
            <img src="{{ asset('images/payment/eye.png') }}" id="retinaImg" class="retina-img d-none">
...
<script>
  ...
  document.getElementById("bioModal").addEventListener("shown.bs.modal", async () => {
    try {
      ...
      bioPayAudio.play().catch(err => console.warn("Audio play prevented:", err));
